...
public class NotificationRequest {
    ...
    @Schema(description = "개별 복용 알림 변경 요청")
    public record UpdateActiveProductNotificationSetting(
            @Schema(description = "변경할 개별 복용 알림 ON/OFF 여부", type = "boolean", example = "false")
