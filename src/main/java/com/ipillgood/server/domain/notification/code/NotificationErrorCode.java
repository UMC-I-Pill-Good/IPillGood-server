...
public enum NotificationErrorCode implements BaseErrorCode {
    ...
    INTAKE_PUSH_SETTING_REQUEST_INVALID(HttpStatus.BAD_REQUEST, "NOTIFICATION400_2", "복용 알림 설정 변경 요청이 올바르지 않습니다."),
    ...
    ACTIVE_PRODUCT_NOTIFICATION_TARGET_ID_INVALID(HttpStatus.BAD_REQUEST, "NOTIFICATION400_5", "개별 알림 대상 ID가 올바르지 않습니다."),
    ACTIVE_PRODUCT_NOTIFICATION_SETTING_REQUEST_INVALID(HttpStatus.BAD_REQUEST, "NOTIFICATION400_6", "개별 알림 설정 변경 요청이 올바르지 않습니다."),
    ...
    ACTIVE_PRODUCT_NOTIFICATION_TARGET_NOT_FOUND(HttpStatus.NOT_FOUND, "NOTIFICATION404_2", "개별 알림을 변경할 섭취 중 영양제를 찾을 수 없습니다."),
    ;
