...
public enum CabinetErrorCode implements BaseErrorCode {
    ...
    REVIEW_PROMPT_ID_INVALID(HttpStatus.BAD_REQUEST, "CABINET400_4", "후기 작성 유도 대상 ID가 올바르지 않습니다."),
    ...
    REVIEW_PROMPT_NOT_FOUND(HttpStatus.NOT_FOUND, "CABINET404_3", "후기 작성 유도 대상을 찾을 수 없습니다."),
