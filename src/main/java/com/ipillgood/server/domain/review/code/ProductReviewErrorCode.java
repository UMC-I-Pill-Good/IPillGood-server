...
public enum ProductReviewErrorCode implements BaseErrorCode {
    ...
    REVIEW_REPORT_FORBIDDEN(HttpStatus.FORBIDDEN, "REVIEW403_5", "본인이 작성한 후기를 신고할 수 없습니다."),
    ...
    REVIEW_REPORT_NOT_FOUND(HttpStatus.NOT_FOUND, "REVIEW404_3", "해당 신고 내역이 존재하지 않습니다."),
    ...
    REVIEW_REPORT_EXISTS(HttpStatus.CONFLICT, "REVIEW409_3", "이미 해당 후기를 신고했습니다."),
    ;
